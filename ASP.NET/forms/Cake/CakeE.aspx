...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="CakeE.aspx.cs" Inherits="IIS.Bakery.CakeE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass + " " +  Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass + " " + Constants.EditFormHeaderCssClass %>">Cake</h2>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlLifetimeLabel" runat="server" Text="Lifetime" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlLifetime" Type="Numeric" runat="server">
</ac:AlphaNumericTextBox>


</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlImagelinkLabel" runat="server" Text="Imagelink" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlImagelink" runat="server">
</asp:TextBox>


</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlPriceLabel" runat="server" Text="Price" EnableViewState="False">
</asp:Label>
<ac:DecimalTextBox CssClass="descTxt" ID="ctrlPrice" runat="server">
</ac:DecimalTextBox>
